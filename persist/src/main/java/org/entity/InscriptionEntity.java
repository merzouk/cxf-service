 ...
 * Créé le 		: 	7 sept. 2014 à 10:45:57
 * Auteur		: 	ryan
 * 
 * Description 	:
 * 
...
public class InscriptionEntity
{
   ...
   @Column(name = "cours", length = 50, nullable = false, unique = false)
   private String  cours;
   
   @Column(name = "dateDuJour", nullable = false, unique = false)
   ...
   public boolean equals( Object obj )
   {
      ...
      InscriptionEntity other = (InscriptionEntity) obj;
      if( cours == null )
      {
