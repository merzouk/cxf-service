Java using jax-ws APIs and jsr-181
=============================================
This  illustrates how to develop a service use the "code first"
approach using the JAX-WS APIs.

Building and running the using Maven
---------------------------------------
From the base directory of this sample (i.e., where this README file is
located), the pom.xml file is used to build and run the . 

Using either UNIX or Windows:

  mvn clean install   (builds the  and creates a WAR file for optional Tomcat deployment)
...
"http://localhost:8080/java_first_jaxws/services/serviceSoapUser".
...
http://localhost:8080/java_first_jaxws/services/serviceSoapUser?wsdl
