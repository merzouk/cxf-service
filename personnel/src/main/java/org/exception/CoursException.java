 ...
 *-------------------------------------------------------- 
 * 
 * Fichier 		:	CoursException.java
 * Créé le 		: 	7 sept. 2014 à 12:59:31
 * Auteur		: 	ryan
 * 
 * Description 	:
 * 
...
public class CoursException extends RuntimeException
{
    ...
    * @since 1.7
    */
   protected CoursException( String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace )
   {
